...
public class MyShoppingRecyclerAdapter2 extends BaseQuickAdapter<ReplyBean,BaseViewHolder> {

    public MyShoppingRecyclerAdapter2(int layoutResId, @Nullable List<ReplyBean> data) {
