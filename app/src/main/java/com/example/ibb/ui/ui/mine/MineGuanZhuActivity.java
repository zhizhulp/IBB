...
public class MineGuanZhuActivity extends BaseNetActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mine_guan_zhu);
        ImageView fans_back_iv = (ImageView) findViewById(R.id.guanzhu_back_iv);
        fans_back_iv.setOnClickListener(this);
        initRefreshLayout();
        adapter = new FansAdapter(R.layout.guanzhu_list_item, datas);
        ...
        mRecyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                PeopleCencerActivity.startPersonCenter(MineGuanZhuActivity.this,datas.get(position).getId());
            }
        });
    ...
    private void requestData(){
        Request request = buildPostListRequest(URLApi.getFollowingUser, User.class);
