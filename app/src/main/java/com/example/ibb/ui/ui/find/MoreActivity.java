...
import com.example.ibb.ui.ui.mine.MineFansActivity;
...
public class MoreActivity extends BaseNetActivity implements View.OnClickListener {
    ...
    private ImageView more_back_iv;
    ...
    protected void initview() {
        more_back_iv = (ImageView) findViewById(R.id.more_back_iv);
        more_back_iv.setOnClickListener(this);
        initRefreshLayout();
        ...
        mRecyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                PeopleCencerActivity.startPersonCenter(MoreActivity.this, datas.get(position).getId());
            }
        });
    ...
    private void requestData() {
        Request request = buildPostListRequest(URLApi.hotAnswererstring, User.class);
        doRequest(0, request);
    }
